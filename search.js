...
submit.onclick = function sear(){
	...
	if((film11.toUpperCase()==text.toUpperCase())|(film12.toUpperCase()==text.toUpperCase())|(film13.toUpperCase()==text.toUpperCase())){
					 var tr = document.createElement('tr');
					tr.innerHTML = '<tr><td><a href="Categories/all/baby.html">Малыш на драйве</a></td><td><a href="Categories/all/baby.html"><img width="10%" src = "Categories/all/images/baby.jpg"></a></td></tr>';
					if(film1==0){
					table.appendChild(tr);
					notfound=1;
					film1=1;
...
if((film11.toUpperCase()==text.toUpperCase())|(film12.toUpperCase()==text.toUpperCase())|(film13.toUpperCase()==text.toUpperCase())){
					 var tr = document.createElement('tr');
					tr.innerHTML = '<tr><td><a href="Categories/all/yourname.html">Твоё имя</a></td><td><a href="Categories/all/yourname.html"><img width="10%" src = "Categories/all/images/yourname.jpg"></a></td></tr>';
if(film2==0){
					table.appendChild(tr);
					notfound=1;
					film2=1;
...
if((film11.toUpperCase()==text.toUpperCase())|(film12.toUpperCase()==text.toUpperCase())|(film13.toUpperCase()==text.toUpperCase())){
					 var tr = document.createElement('tr');
					tr.innerHTML = '<tr><td><a href="Categories/all/wolf.html">Волк с Уолл-Стрит</a></td><td><a href="Categories/all/wolf.html"><img width="10%" src = "Categories/all/images/wolf.jpg"></a></td></tr>';
		if(film3==0){
					table.appendChild(tr);
					notfound=1;
					film3=1;
